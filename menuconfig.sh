...
DEFAULT_DEVICE=sailfish

# default target name
DEFAULT_TARGET=nethunter

# directory containing cross-compile arm64 toolchain (change this!)
# Linaro GCC 5.5 (this script's original default), from Kali's toolchain mirror:
#   https://kali.download/nethunter-images/toolchains/linaro-aarch64-5.5.tar.xz
# Google's aarch64-linux-android-4.9 does NOT work here: this tree's
# include/linux/compiler-gcc.h requires GCC 5.1 or newer.
TOOLCHAIN=/home/will/dev/toolchains/linaro-aarch64-5.5/aarch64-linaro-5.5
...
export ARCH=arm64
export CROSS_COMPILE=$TOOLCHAIN/bin/$TOOLCHAIN_PREFIX
